...
class Snake3DGame:
    ...
    def _wrap(self, v):
        m = self.grid_size * 2
        return 0 if v >= m else (m-2 if v < 0 else v)

    def _is_reverse(self, nd):
        return nd[0]==-self.direction[0] and nd[1]==-self.direction[1] and nd[2]==-self.direction[2]
